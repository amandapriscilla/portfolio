...
function mssql_real_escape_string($s) {
    ...
    function  __construct($tabela = 'funcionario', $campoID = 'idFuncionario', $campoLogin = 'login', $campoSenha = 'senha') {
    ...
    function logar($login, $senha, $redireciona = null) {
        ...
        //$senha = mssql_real_escape_string($senha);

        // Verifica se o usuário existe
        $query = mssql_query("SELECT {$this->campoID}, {$this->campoLogin}, {$this->campoSenha}
                             FROM {$this->tabela}
